...
export default function Wishes() {
  ...
  // Fetch existing wishes from SheetDB
  useEffect(() => {
    fetch('https://sheetdb.io/api/v1/ei3zzovqdl0v5?sort_by=id&sort_order=desc')
      .then((res) => res.json())
      .then((data) => {
        setWishes(data);
      })
  ...
  const handleSubmitWish = async (e) => {
    ...
    const newWishObj = {
      ...
      attending: attendance || "maybe",
    };

    try {
      // Save to SheetDB
      await fetch("https://sheetdb.io/api/v1/ei3zzovqdl0v5", {
        method: "POST",
        headers: {
          Accept: "application/json",
          "Content-Type": "application/json",
        },
        body: JSON.stringify({ data: [newWishObj] }),
      });
